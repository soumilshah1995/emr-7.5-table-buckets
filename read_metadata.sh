...
export JOB_PATH="/path/to/read_s3_metadata.py"
export S3_JOB_PATH="s3://$S3_BUCKET_NAME/jobs/read_s3_metadata.py"
...
CLUSTER_ID=$(aws emr create-cluster \
  ...
  --auto-terminate \
  --steps '[{"Name":"Iceberg PySpark Job","ActionOnFailure":"CONTINUE","Jar":"command-runner.jar","Args":["spark-submit","--packages","software.amazon.s3tables:s3-tables-catalog-for-iceberg:0.1.0,org.apache.iceberg:iceberg-spark-runtime-3.4_2.12:1.6.0","s3://$S3_BUCKET_NAME/jobs/read_s3_metadata.py"],"Type":"CUSTOM_JAR"}]' \
